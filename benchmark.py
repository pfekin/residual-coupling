...
# =============================================================================
# ARCHITECTURE: Synergy-X Latent Bridges
# =============================================================================
...
class LatentBridge(nn.Module):
    def __init__(self, dim, mode):
        ...
        # PRIMARY: Specialist -> Generalist (B helps A)
        ...
        if "bilateral" in mode:
            # SECONDARY: Generalist -> Specialist (A helps B)
    ...
    def forward(self, h_A, h_B):
        # Steer the Generalist (A) using Specialist (B) features
...
def run():
    ...
    for mode in modes:
        ...
        it = iter(ds.shuffle(seed=SEED))
        engine = DifferanceEngine(model_A, model_B, mode).to(DEVICE).to(model_A.dtype)
        ...
        with torch.no_grad():
            ...
            results[mode] = {
                "fused": get_ppl(fused),
                "steered_A": get_ppl(steered_A),
                "steered_B": get_ppl(steered_B)
            }
...
"""
══════════════════════════════════════════════════════════════════════════════════════════
 FINAL BENCHMARK, STEERED AGENTS: MEDICAL
──────────────────────────────────────────────────────────────────────────────────────────
 MODE                   | FUSED PPL    | STEERED A    | STEERED B    | DOMAIN GAIN
──────────────────────────────────────────────────────────────────────────────────────────
 Baseline (Frozen)      | -            | 50.05        | 317.89       |
──────────────────────────────────────────────────────────────────────────────────────────
 logit_ensemble         | 69.49        | 50.05        | 318.49       | (-38.83%)
 moe                    | 64.66        | 47.05        | 160.50       | (-29.18%)
 unilateral             | 13.08        | 23.62        | 318.49       | (+73.87%)
 bilateral              | 12.01        | 15.54        | 22.59        | (+76.01%)
 bilateral_no_gate      | 13.73        | 64.02        | 26.81        | (+72.56%)
 bilateral_random       | 109.55       | 160.98       | 314.95       | (-118.88%)
══════════════════════════════════════════════════════════════════════════════════════════

══════════════════════════════════════════════════════════════════════════════════════════
 FINAL BENCHMARK, STEERED AGENTS: LEGAL
──────────────────────────────────────────────────────────────────────────────────────────
 MODE                   | FUSED PPL    | STEERED A    | STEERED B    | DOMAIN GAIN
──────────────────────────────────────────────────────────────────────────────────────────
 Baseline (Frozen)      | -            | 26.48        | 44.44        |
──────────────────────────────────────────────────────────────────────────────────────────
 logit_ensemble         | 25.33        | 26.48        | 44.44        | (+4.34%)
 moe                    | 21.83        | 20.23        | 27.89        | (+17.57%)
 unilateral             | 9.50         | 11.71        | 44.44        | (+64.11%)
 bilateral              | 8.30         | 10.64        | 10.84        | (+68.65%)
 bilateral_no_gate      | 8.13         | 10.63        | 12.88        | (+69.31%)
 bilateral_random       | 26.11        | 28.88        | 48.79        | (+1.39%)
══════════════════════════════════════════════════════════════════════════════════════════

══════════════════════════════════════════════════════════════════════════════════════════
 FINAL BENCHMARK, STEERED AGENTS: CODING
──────────────────────────────────────────────────────────────────────────────────────────
 MODE                   | FUSED PPL    | STEERED A    | STEERED B    | DOMAIN GAIN
──────────────────────────────────────────────────────────────────────────────────────────
 Baseline (Frozen)      | -            | 16.68        | 7010478.84   |
──────────────────────────────────────────────────────────────────────────────────────────
 logit_ensemble         | 596.16       | 16.68        | 7010478.84   | (-3473.39%)
 moe                    | 878.40       | 18.26        | 23417365.46  | (-5165.14%)
 unilateral             | 15.15        | 32.11        | 7010478.84   | (+9.22%)
 bilateral              | 5.91         | 11.29        | 19461.47     | (+64.60%)
 bilateral_no_gate      | 4.95         | 9.83         | 13251.01     | (+70.31%)
 bilateral_random       | 499.93       | 16.70        | 3901037.28   | (-2896.62%)
══════════════════════════════════════════════════════════════════════════════════════════

══════════════════════════════════════════════════════════════════════════════════════════
 FINAL BENCHMARK, STEERED AGENTS: SCIENTIFIC
──────────────────────────────────────────────────────────────────────────────────────────
 MODE                   | FUSED PPL    | STEERED A    | STEERED B    | DOMAIN GAIN
──────────────────────────────────────────────────────────────────────────────────────────
 Baseline (Frozen)      | -            | 28.54        | 28.77        |
──────────────────────────────────────────────────────────────────────────────────────────
 logit_ensemble         | 27.56        | 28.54        | 28.83        | (+3.43%)
 moe                    | 26.85        | 26.87        | 26.96        | (+5.93%)
 unilateral             | 18.73        | 19.77        | 28.83        | (+34.39%)
 bilateral              | 17.51        | 18.35        | 18.24        | (+38.66%)
 bilateral_no_gate      | 21.44        | 27.76        | 30.15        | (+24.89%)
 bilateral_random       | 28.54        | 30.14        | 30.32        | (-0.00%)
══════════════════════════════════════════════════════════════════════════════════════════
"""
